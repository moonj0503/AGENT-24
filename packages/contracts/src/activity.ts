...
export const ActivityEventSchema = z.object({
  ...
  application: z.object({ name: z.string().min(1), category: z.enum(["DOCUMENT", "DEVELOPMENT", "BROWSER", "COMMUNICATION", "OTHER"]) }),
  resource: z.object({ title: z.string().min(1), kind: z.enum(["DOCUMENT", "CODE", "WEB_PAGE", "CHAT", "OTHER"]) }).optional(),
