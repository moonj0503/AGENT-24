...
import type { ActionPlan, ActionResult, Artifact, Checkpoint, GapSession, Goal, RecoveryBrief } from "@continuity/contracts";
...
let snapshot: DesktopWorkflowState = { workSessionId: "", actionResults: [], artifacts: [], phase: "OBSERVING", pending: false };
